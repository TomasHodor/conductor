      ...
      <div className="left-menu" style={{ width }}>
        <div className="logo textual pull-left">
          <a href="/" title="Frinx Conductor">
            <h4>
                <i className={this.state.loading?"fa fa-bars fa-spin fa-1x":""}></i>
                {this.state.loading || minimize?'':<img src="/images/FRINX_logo_smaller.png" width="120" alt="Frinx" margin="15px"></img>}</h4>
          </a>
        </div>
